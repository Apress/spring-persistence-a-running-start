...
public class ArtDataDaoJdbc extends GenericDaoJdbc<ArtData> implements ArtDataDao{

   public ArtDataDaoJdbc(){
      super(ArtData.class, "artdata");
   }
...
//                this.getHibernateTemplate().initialize(entity.getThumbnailPicture());
   ...
   protected String getUpdateSql() {
      return "UPDATE ArtData SET picture = :picture, version = :version WHERE id = :id";
   }
}
